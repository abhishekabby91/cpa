/**
 * Redirects from a client's previous website.
 *
 ...
 * common way a redesign loses rankings the firm already had — the pages still
 ...
 *      redirect to the nearest useful parent — /services or /, not a 404.
...
export const redirects: Redirect[] = [
  ...
  //
  // { source: "/tax-services", destination: "/services/individual-tax-preparation" },
  // { source: "/about-us", destination: "/about" },
  // { source: "/our-staff", destination: "/team" },
  // { source: "/blog/:slug", destination: "/resources/blog/:slug" },
