 ...
 * your client. Which regime governs a given firm — GDPR, UK GDPR, CCPA/CPRA,
 * state privacy acts — depends on where their visitors are and what data they
 * process, and that call belongs to the firm's counsel.
 *
...
export interface ConsentConfig {
  ...
  expiryDays: number;
  /** Set false only if the client has no cookies beyond strictly necessary. */
  enabled: boolean;
  banner: {
    title: string;
    body: string;
...
export const consentConfig: ConsentConfig = {
  ...
  /**
   * Keep this list accurate for each client. It is a disclosure, and a cookie
  ...
  categories: [
    ...
    },
    {
      ...
      label: "Functional",
      description:
        "Remember choices you make, such as a scheduling widget's state. The site works without them.",
      required: false,
      cookies: [],
    },
    {
    ...
    },
    {
      ...
      label: "Advertising",
      description:
        "Used to measure advertising and show relevant ads on other sites. Only set if the firm runs paid campaigns.",
      required: false,
      cookies: [],
    },
  ],
